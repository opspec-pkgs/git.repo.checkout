[![Build Status](https://github.com/opspec-pkgs/git.repo.checkout/workflows/build/badge.svg?branch=main)](https://github.com/opspec-pkgs/git.repo.checkout/actions?query=workflow%3Abuild+branch%3Amain)
