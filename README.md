[![build](https://github.com/opspec-pkgs/git.repo.checkout/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/git.repo.checkout/actions/workflows/build.yml)
